...
#         "registro1.txt", "registro2.txt", run_count, "programa1"), name="Thread1")
#     thread2 = threading.Thread(target=thread_function, args=(
#         "registro1.txt", "registro2.txt", run_count, "programa1"), name="Thread2")
#     thread3 = threading.Thread(target=thread_function, args=(
#         "registro1.txt", "registro2.txt", run_count, "programa1"), name="Thread3")
...
#     p1 = multiprocessing.Process(target=programa_1)
#     p2 = multiprocessing.Process(target=programa_2)
#     p1.start()
#     p2.start()
#     p1.join()
#     p2.join()